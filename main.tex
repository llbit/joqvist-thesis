...
% columns=fullflexible to fix spacing around inline code
% https://tex.stackexchange.com/questions/115542/ugly-spacing-in-lstinline
\def\inline{\lstinline[columns=fullflexible,basicstyle=\sffamily,keywordstyle={}]}
